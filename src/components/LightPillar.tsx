...
const LightPillar: React.FC<LightPillarProps> = ({
  ...
  useEffect(() => {
    ...
    // Reduce pixel ratio for performance (0.5-1.0 for heavy shaders)
    ...
    // Animation loop with fixed timestep (30 FPS for decorative animation)
    ...
    const animate = (currentTime: number) => {
      ...
      if (deltaTime >= frameTime) {
        timeRef.current += 0.033 * rotationSpeed; // ~30 FPS timestep
